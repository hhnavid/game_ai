...
class RacingAgent_v2:
    ...
    def reset(self):
        ...
        if self.log_path_prefix is not None and not os.path.exists(
            os.path.join(self.log_path_prefix, self.log_name)
        ):
        ...
        while True:
            ...
            self.log_data.append(cmd)
            self.log_data.append(reset_status)
    ...
    def get_nearest_spline_pnts(self, lvl_id, spline_id, veh_3dpos_str):
        ...
        self.log_data.append(cmd)
        self.log_data.append(splines_str)
    ...
    def get_range_data(self, ray_origin, zero_heading):
        ...
        for ang in np.arange(
            ...
            self.log_data.append(ray_trace_cmd)
            self.log_data.append(resp_str)
    ...
    def get_obs(self):
        ...
        self.log_data.append(cmd)
        self.log_data.append(self.agent_pos_str)
        ...
        self.log_data.append(speed_cmd)
        self.log_data.append(resp_str)
        ...
        self.log_data.append(cmd)
        self.log_data.append(road_width)
        ...
        self.log_data.append(cmd)
        self.log_data.append(coll_resp)
        ...
        self.log_data.append(lap_prog_cmd)
        self.log_data.append(cur_prog)
        ...
        if self.debug_plot:
            ...
            for i in range(self.num_rivals):
                ...
                self.log_data.append(cmd)
                self.log_data.append(rival_pos_str)
    ...
    def step(self, action_idx):
        ...
        self.log_data.append(action_cmd)
        self.log_data.append(resp)
        # print(
